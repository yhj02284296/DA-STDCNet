...
if __name__ == "__main__":
    ...
    evaluatev0('./checkpoints/BiSeSTDC_seg/pths/model_maxmIOU50.pth', dspth='./data',
               backbone='BiSeSTDCNet', scale=0.5,
               use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)

    # STDC1-Seg75 mIoU 0.7450
    evaluatev0('./checkpoints/BiSeSTDC_seg/pths/model_maxmIOU75.pth', dspth='./data', backbone='BiSeSTDCNet', scale=0.75,
    use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)
